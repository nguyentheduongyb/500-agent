...
export const SearchItem: React.FC<SearchItemProps> = ({ categories, name, description, image, price, sale, stars, reviews, duration, ranks }: SearchItemProps) => {
        return (
                <div className="w-full rounded-lg border drop-shadow p-2 bg-white flex gap-6">
                        <div className="w-1/4 flex flex-col gap-2">
                                <div className="rounded-xl w-full pt-[74%] bg-center bg-no-repeat bg-cover" style={{ backgroundImage: 'url("https://cdn1.ivivu.com/iVivu/2022/06/30/12/hinhdaidien-374x280.webp?o=jpg")' }}></div>
                                <div className="rounded-xl w-full pt-[50%] bg-center bg-no-repeat bg-cover" style={{ backgroundImage: 'url("https://cdn1.ivivu.com/iVivu/2022/06/30/12/hinhdaidien-374x280.webp?o=jpg")' }}></div>
                        </div>
                        <div className="flex-1">
                                ...
                                <div className='w-full flex gap-8 mt-2'>
                                        <div className="flex-1">
                                                <Link href="" className='w-full text-xl font-bold line-clamp-2 hover:underline'>{name}</Link>
                                                ...
                                                <div className="w-full flex gap-4 mt-3">
                                                        <div className="w-1/3 space-y-3 text-sm font-medium">
                                                                <p>Destinations</p>
                                                                <p>Age Range</p>
                                                                <p>Operated in</p>
                                                                <p>Operator</p>
                                        ...
                                        <div className="w-1/3">
                                                ...
                                                <div className='w-full flex flex-col gap-3 mt-8 items-center'>
                                                        <button className='w-[80%] py-2 rounded-full text-sm font-medium text-white bg-[color:var(--primary-color)]'>View Tour</button>
                                                        <button className='w-[80%] py-2 rounded-full text-sm font-medium bg-[#CDE9FC] text-[color:var(--primary-color)]'>Download Brochure</button>
                                                </div>
                                        </div>
                                </div>
